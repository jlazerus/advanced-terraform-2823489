...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "jlazerus-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "jlazerus-tfremotestate" {
  bucket = aws_s3_bucket.jlazerus-tfremotestate.id
